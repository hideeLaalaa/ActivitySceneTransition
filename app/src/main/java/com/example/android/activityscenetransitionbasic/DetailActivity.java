...
//        mItem = Item.getItem(getIntent().getIntExtra(EXTRA_PARAM_ID, 0));
    ...
    private void loadItem() {
        ...
        mHeaderTitle.setText(getString(R.string.image_header, titleData, authorData));
    ...
    private void loadThumbnail() {
        if (titleData.equals("Flying in the Light") ){

            Picasso.get()
                    .load("https://firebasestorage.googleapis.com/v0/b/online-store-app-d9136.appspot.com/o/Screenshot%20(118).png?alt=media&token=d77773e3-3932-426d-8549-5a93d1fecbcd")
                    .noFade()
